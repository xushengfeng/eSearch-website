...
function show_download() {
    ...
    var source_d = `<a target="_blank" href="https://${fasturl ? "hub.fastgit.xyz" : "github.com"}/xushengfeng/eSearch/archive/refs/tags/${v}.tar.gz"><div class="download_b"><span>.tar</span>tar 压缩源代码</div></a>
    <a target="_blank" href="https://${fasturl ? "hub.fastgit.xyz" : "github.com"}/xushengfeng/eSearch/archive/refs/tags/${v}.zip"><div class="download_b"><span>.zip</span>zip 压缩源代码</div></a>`;
